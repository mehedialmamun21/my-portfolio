    ...
    return (
        <section className='py-20 flex justify-center bg-primary'>
            <div>
                ...
                <div className='container lg:border pb-5 lg:px-5 rounded-xl my-20'>
                    <h1 className='py-8 text-3xl lg:text-2xl text-white'>Contact Form</h1>
                    <form className='row' onSubmit={sendEmail}>
                        <div className='flex flex-col items-center'>
                            <div>
                                <label className='text-warning'>Name</label>
                                <input type="text" name="user_name" className='form-control w-80 mt-2 rounded py-1' required />
                            </div>
                            <div className='my-3'>
                                <label className='text-warning'>Email</label>
                                <input type="email" name="user_email" className='form-control w-80 mt-2 rounded py-1' required />
                            </div>
                            <div>
                                <label className='text-warning'>Message</label>
                                <textarea name='message' rows="4" className='form-control w-80 mt-2 rounded' required />
                            </div>
