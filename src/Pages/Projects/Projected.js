        ...
        <div class="card lg:card-side border-2 border-t-blue-400 border-zinc-300 rounded-none bg-white shadow-[4.0px_8.0px_8.0px_rgba(0,0,0,0.38)] lg:px-0">
            ...
            <div class="card-body ">
                ...
                <div className='flex justify-between items-center'>
                    ...
                    <button className='bg-gradient-to-r from-[var(--primary-purple)] to-[var(--primary-blue)] hover:bg-gradient-to-r hover:from-[var(--primary-blue)] hover:to-[var(--primary-purple)] text-white px-7 lg:px-7 py-1 text-lg' onClick={() => navigateToProjectDetail(id)}>Details</button>
