        ...
        <div class="card lg:card-side border border-zinc-300 rounded-none bg-white shadow-2xl lg:px-3" data-aos="zoom-in-right">
            ...
            <div class="card-body ">
                ...
                <div className='flex justify-between items-center'>
                    <button className='btn text-white w-2/4 lg:w-2/4 mt-2 border-none rounded-none hover:bg-gradient-to-r hover:from-[var(--primary-blue)] hover:to-[var(--primary-purple)]' onClick={() => navigateToProjectDetail(id)}>Details</button>
