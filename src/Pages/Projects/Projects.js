...
const Projects = () => {
    ...
    const projects = [
        { id: 1, img: "https://i.postimg.cc/c4tXWFx9/cms.png", name: 'Multipurpose Medical Service Provider', about: "This site is build for offering Dental services for users. User can booking consaltant and make payment by cards." },
        ...
        { id: 4, img: "https://i.postimg.cc/c4tXWFx9/cms.png", name: 'License Plate Detection (Machine Learning)', about: "By this, we can detect vehicles (car's) number plate accurately." },
    ...
    return (
        <section className='px-5 lg:px-20 pt-20 pb-10 lg:pt-20'>
            ...
            <div className=''>
                <h1 className='text-3xl lg:text-4xl text-zinc-700 pb-10 font-semibold lg:py-10 flex justify-center'>Recent <span className='text-orange-400'>Projects</span> </h1>
