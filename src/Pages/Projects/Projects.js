...
const Projects = () => {
    ...
    const projects = [
        { id: 1, img: "https://i.postimg.cc/c4tXWFx9/cms.png", name: 'Dental Services Provider, offering E-Commerce Functionality for Dental Product Sales.', about: "This site is build for offering Dental services for users. User can booking consaltant and make payment by cards." },
