...
const Projects = () => {
    ...
    const projects = [
        ...
        { id: 3, img: "https://i.postimg.cc/c4tXWFx9/cms.png", name: 'Doctors Portal', about: "This site is build for offering Dental services for users. User can booking consaltant and make payment by cards." }
    ]
